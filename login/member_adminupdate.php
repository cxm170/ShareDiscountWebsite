        ...
        <td class="tdrline"><form action="" method="POST" name="formJoin" id="formJoin" onSubmit="return checkForm();">
          <div class="dataDiv">
            ...
            <p><strong>Confirm Password:</strong>
              ...
              <br>
              <span class="smalltext">If you do not want to change your password, please do not fill in.<br>To modify, please enter the password.</span><span class="smalltext"><br></span></p>
            <hr size="1" />
            <p class="heading">Personal Information</p>
            <p><strong>Real Name:</strong><br>Firstname
            ...
            <p><strong>Address:</strong>
                <input name="m_address" type="text" class="normalinput" id="m_address" value="<?php echo $row_RecMember["m_address"];?>" size="40" placeholder="Your address">
            </p>
...
<div class="regbox">
          <p class="heading"><strong>Membership Management System</strong></p>
            ...
            <p align="center"><a href="member_centeradmin.php">Centre</a> | <a href="?logout=true">Log Out</a></p>
</div>
