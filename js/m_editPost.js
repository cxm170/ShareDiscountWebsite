   ...
   var post_content=document.getElementById(contentID);
	 ...
	 post_div.innerHTML="<span><span><br><form align='center'><textarea id='title2' name='title2' type='text' rows='1' cols='70'>"+post_title.innerHTML+"</textarea><br><textarea id='content2' name='content2' type='text' rows='5' cols='70'>"+post_content.innerHTML+"</textarea><br><input class='m_updatePost' type='button' value='Update'><br><br><input type='hidden' id='updatePost' value='"+ID+"'></form></span></span>";
