...
while(($row = mysql_fetch_array($result))&&($i>0)){
  ...
  echo "<a target='_blank' font href='m_readPost.php?id=".$row['ID']."'><strong class='title2' id='title-".$row['ID']."'>" . $row['post_title'] . "</strong></a>";
  ...
  echo "<a style='float:right; margin-right: 2px;' target='_blank' id='commentcount-".$row['ID']."'  
        href='m_readPost.php?id=".$row['ID']."'>Comment (" . $commentcount['count'] . ")</a>";
